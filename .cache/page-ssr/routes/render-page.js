...
var React = _interopRequireWildcard(__webpack_require__(5671));
...
var _react = _interopRequireDefault(__webpack_require__(5671));
...
exports.components={"component---cache-caches-gatsby-plugin-offline-app-shell-js":()=>__webpack_require__.e(/* import() | component---cache-caches-gatsby-plugin-offline-app-shell-js */ 306).then(__webpack_require__.bind(__webpack_require__, 1367)),"component---node-modules-gatsby-theme-portfolio-minimal-src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-gatsby-theme-portfolio-minimal-src-pages-404-tsx */ 965).then(__webpack_require__.bind(__webpack_require__, 5577)),"component---node-modules-gatsby-theme-portfolio-minimal-src-templates-article-listing-index-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-gatsby-theme-portfolio-minimal-src-templates-article-listing-index-tsx */ 226).then(__webpack_require__.bind(__webpack_require__, 1836)),"component---src-pages-imprint-js":()=>__webpack_require__.e(/* import() | component---src-pages-imprint-js */ 683).then(__webpack_require__.bind(__webpack_require__, 3598)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 3859)),"component---src-pages-privacy-js":()=>__webpack_require__.e(/* import() | component---src-pages-privacy-js */ 844).then(__webpack_require__.bind(__webpack_require__, 8897))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(1674),options:{"plugins":[]}},{name:'gatsby-plugin-image',plugin:__webpack_require__(2588),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"name":"Joseph Bienvenu","short_name":"Bienvenu","start_url":"/","background_color":"#FFFFFF","theme_color":"#000000","display":"minimal-ui","icon":"./content/images/favicon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"6d5bf3099f34c83917660d6466e9e9bf"}},{name:'gatsby-plugin-offline',plugin:__webpack_require__(8379),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/joseph-bienvenu-portfolio-minimal"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/joseph-bienvenu-portfolio-minimal"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/joseph-bienvenu-portfolio-minimal"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromises,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// CONCATENATED MODULE: ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
...
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
const fullStack=external_C_Users_jbien_git_dev_GitHub_joseph_bienvenu_portfolio_minimal_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();// remove the first line of the stack trace
...
/* harmony export */ });
const React=__webpack_require__(5671);const{grabMatchParams}=__webpack_require__(9755);const{createElement}=__webpack_require__(5671);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,warnForInvalidTags}=__webpack_require__(8317);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(9144);const{parse}=__webpack_require__(698);const{VALID_NODE_NAMES}=__webpack_require__(2460);function headHandlerForSSR({pageComponent,setHeadComponents,staticQueryContext,pageData,pagePath}){if(pageComponent!==null&&pageComponent!==void 0&&pageComponent.Head){headExportValidator(pageComponent.Head);function HeadRouteHandler(props){var _pageData$result,_pageData$result$page;const _props={...props,...pageData.result,params:{...grabMatchParams(props.location.pathname),...(((_pageData$result=pageData.result)===null||_pageData$result===void 0?void 0:(_pageData$result$page=_pageData$result.pageContext)===null||_pageData$result$page===void 0?void 0:_pageData$result$page.__params)||{})}};return createElement(pageComponent.Head,filterHeadProps(_props));}const routerElement=/*#__PURE__*/React.createElement(StaticQueryContext.Provider,{value:staticQueryContext},/*#__PURE__*/React.createElement(ServerLocation,{url:`${"/joseph-bienvenu-portfolio-minimal"}${pagePath}`},/*#__PURE__*/React.createElement(Router,{baseuri:"/joseph-bienvenu-portfolio-minimal",component:({children})=>/*#__PURE__*/React.createElement(React.Fragment,null,children)},/*#__PURE__*/React.createElement(HeadRouteHandler,{path:"/*"}))));// extract head nodes from string
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var React=_interopRequireWildcard(__webpack_require__(5671));var _gatsby=__webpack_require__(7076);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5671);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(5671),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
var React = __webpack_require__(5671);
...
"use strict";
module.exports = require("C:\\Users\\jbien\\git-dev\\GitHub\\joseph-bienvenu-portfolio-minimal\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\jbien\\git-dev\\GitHub\\joseph-bienvenu-portfolio-minimal\\.cache\\ssr-builtin-trackers\\http");
...
"use strict";
module.exports = require("C:\\Users\\jbien\\git-dev\\GitHub\\joseph-bienvenu-portfolio-minimal\\.cache\\ssr-builtin-trackers\\https");
...
"use strict";
module.exports = require("C:\\Users\\jbien\\git-dev\\GitHub\\joseph-bienvenu-portfolio-minimal\\node_modules\\react-dom\\server.js");
...
/******/ 			return "" + {"226":"component---node-modules-gatsby-theme-portfolio-minimal-src-templates-article-listing-index-tsx","306":"component---cache-caches-gatsby-plugin-offline-app-shell-js","678":"component---src-pages-index-js","683":"component---src-pages-imprint-js","844":"component---src-pages-privacy-js","965":"component---node-modules-gatsby-theme-portfolio-minimal-src-pages-404-tsx"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
await apiRunnerAsync(`replaceRenderer`,{bodyComponent,replaceBodyHTMLString,setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,pathPrefix:"/joseph-bienvenu-portfolio-minimal"});// If no one stepped up, we'll handle it.
