...
module.exports = function (_ref, pluginOptions) {
  ...
  var generateImagesAndUpdateNode = /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(node, resolve, inLink, overWrites) {
      var parentNode, tempParentNode, imagePath, imageNode, fluidResult, originalImg, fallbackSrc, srcSet, presentationWidth, srcSplit, fileName, fileNameNoExt, defaultAlt, isEmptyAlt, alt, title, loading, decoding, imageStyle, imageTag, formatConfigs, enabledFormatConfigs, sourcesHtmlPromises, sourcesHtml, placeholderImageData, ratio, wrapperStyle, imageCaption, removeBgImage, imageStats, bgImage, rawHTML;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              parentNode = getNode(markdownNode.parent); // check if the parent node is a File node, otherwise go up the chain and
              ...
              if (parentNode && parentNode.internal && parentNode.internal.type !== "File") {
                tempParentNode = parentNode;

                while (tempParentNode && tempParentNode.internal && tempParentNode.internal.type !== "File") {
                  tempParentNode = getNode(tempParentNode.parent);
                }

                if (tempParentNode && tempParentNode.internal && tempParentNode.internal.type === "File") {
            ...
            case 49:
              placeholderImageData = fluidResult.base64;
